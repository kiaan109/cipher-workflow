...
export const WebhookTriggerNode = memo((props: NodeProps<T>) => {
  ...
  return (
    <>
      <WebhookTriggerDialog open={open} onOpenChange={setOpen} onSubmit={handleSubmit} defaultValues={props.data as Partial<WebhookTriggerFormValues>} />
      <BaseExecutionNode
        {...props}
        id={props.id}
        icon={WebhookIcon}
        ...
        status={status}
        description={props.data.variableName ? `→ {{${props.data.variableName}}}` : "Not configured"}
